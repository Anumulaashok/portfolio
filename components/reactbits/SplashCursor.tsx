/* eslint-disable */
// @ts-nocheck — ported WebGL fluid sim from React Bits; not practical to type inline
// Fluid cursor from React Bits (https://reactbits.dev) — copy-paste WebGL component
"use client";
...
const ACCENT_PALETTE = ["#8b5cf6", "#06b6d4", "#d946ef"];
...
/** Global splash cursor with reduced-motion and coarse-pointer guards. */
export function SplashCursorEffect({
  enabled = process.env.NEXT_PUBLIC_SPLASH_CURSOR !== "false",
}: {
  enabled?: boolean;
}) {
  ...
  if (!enabled || reducedMotion || !finePointer) return null;
